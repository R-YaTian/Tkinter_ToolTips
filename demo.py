...
try:
    ...
    ttk.Label(app_window, text="Try resizing the window to see the changes to the tooltip!",
              font=font_obj).grid(row=0, column=0, columnspan=3, sticky="N,W")
